...
\objective{Highly motivated and detail-oriented Entry Level Software Engineer with a strong foundation in computer science and software development. Proficient in a range of programming languages, including Java, Python, and SQL. Excellent communication skills and a strong desire for continuous learning and improvement.}
...
% ------ Skills -----
\section{Skills}
\skills{Java, Python, SQL, C, Salesforce,
    Tableau, PowerBI,
    Operating Systems(Windows, Linux),
    Agile methodologies,  Git,
    Cloud platforms( Google Cloud Engine, Microsoft Azure)
...
\project{Coursera - Ongoing}{Salesforce Sales Operations Professional Certificate} {}{} {}
